...
class ImageInferencer(Node):
    ...
    def _inferenzzia(self, data):
        ...
        # Aplicar Gaussian Blur para reduzir o ruído
        blurred_img = cv2.GaussianBlur(img, (5, 5), 0)
        
        # Converter para o espaço de cores LAB para aplicar CLAHE no canal L
        ...
        # Reunir os canais e converter de volta para BGR
